...
if($_SERVER["REQUEST_METHOD"] == "GET"){
    $input_room_id = trim($_GET["id"]);
    $sql = "SELECT * FROM rooms WHERE room_id = $input_room_id";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($room_id_err) && empty($room_name_err) && empty($room_price_err) && empty($room_description_err)){
        $sql = "UPDATE rooms 
                SET room_name = '$room_name', room_price = '$room_price',  room_description = '$room_description' 
...
<div class="wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="mt-5">Обновить номер</h2>
