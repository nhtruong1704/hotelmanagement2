    ...
    <table class="table table-striped text-center">
        <tr>
            <th colspan="10">
                ...
                <a href="AddReceptionist.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Добавить
                    новый регистратор</a>
            </th>
        </tr>
        <t>
        ...
        foreach ($result as $row) {
            ...
            <tr>
                ...
                <td>
                    <a href="UpdateReceptionist.php?id=<?php echo $row['receptionist_id'] ?>" class="mr-3"
