...
if($_SERVER["REQUEST_METHOD"] == "GET"){
    $input_admin_id = trim($_GET["id"]);
    $sql = "SELECT * FROM admins WHERE admin_id = $input_admin_id";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($admin_id_err) && empty($admin_name_err) && empty($admin_phone_err) && empty($admin_email_err)&& empty($admin_password_err)){
        $sql = "UPDATE admins 
                SET admin_name = '$admin_name', admin_phone = '$admin_phone',  admin_email = '$admin_email',  admin_password = '$admin_password' 
...
<div class="wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="mt-5">Обновить администратор</h2>
